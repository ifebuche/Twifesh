# Twifesh
After some frustrations with tweepy around the v2 of Twitter API, I decided to write TwiFesh initially to stream tweets and write them to a json file. <br>
